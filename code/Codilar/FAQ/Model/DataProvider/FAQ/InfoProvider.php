<?php
namespace Codilar\FAQ\Model\DataProvider\FAQ;
use Codilar\FAQ\Model\ResourceModel\FAQ\Collection as Collection;
use Codilar\FAQ\Model\ResourceModel\FAQ\CollectionFactory as CollectionFactory;
...
class InfoProvider extends AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        foreach ($items as $item) {
            $faqData = $item->getData();
            $this->loadedData[$item->getId()] = $faqData;
        }
        return $this->loadedData;
    }
}
